...
const DICT: Record<string, Entry> = {
  ...
  'story.p0': {
    ...
    eu: 'Landetxe boutique bat mahastien artean eta Bizkaiko haranaren isiltasunean, San Joan Gaztelugatxekotik hiru kilometrora. Harria, egurra eta argi leuna.',
    nl: 'Een boutique-landhuis tussen de wijngaarden en de stilte van het Biskaje-dal, op drie kilometer van San Juan de Gaztelugatxe. Steen, hout en zacht licht.',
    no: 'Et boutique-landsted blant vinranker og stillheten i Biscaya-dalen, tre kilometer fra San Juan de Gaztelugatxe. Stein, tre og mykt lys.',
    da: 'Et boutique-landsted blandt vinstokke og stilheden i Biscaya-dalen, tre kilometer fra San Juan de Gaztelugatxe. Sten, træ og blødt lys.',
  },
  'story.p1': {
  ...
  'place.i1.d': {
    ...
    eu: 'Uharte ikonikoa eta bere ermita, 3 km-ra baino ez.',
    nl: 'Het iconische eilandje en zijn kluis, op slechts 3 km.',
    no: 'Den ikoniske holmen og eremittboligen, bare 3 km unna.',
    da: 'Den ikoniske holm og dens kapel, kun 3 km væk.',
  },
