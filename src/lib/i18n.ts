...
const DICT: Record<string, Entry> = {
  ...
  // Storytelling — anfitriona + enlace
  'story.host': {
    es: 'Te recibe Maialen, tu anfitriona.',
    eu: 'Maialenek, zure ostalariak, hartuko zaitu.',
    fr: 'Maialen, votre hôtesse, vous accueille.',
    en: 'Maialen, your host, welcomes you.',
    it: 'Ti accoglie Maialen, la tua host.',
    nl: 'Maialen, je gastvrouw, verwelkomt je.',
    no: 'Maialen, verten din, tar imot deg.',
    da: 'Maialen, din vært, tager imod dig.',
    de: 'Maialen, deine Gastgeberin, heißt dich willkommen.',
  },
  'story.discover': {
  ...
  // Concierge
  'cc.title': {
    es: 'Concierge {brand}', eu: '{brand} Concierge', fr: 'Concierge {brand}', en: '{brand} Concierge',
  ...
  'footer.near': {
    es: 'A 10 min de San Juan de Gaztelugatxe · 30 min de Bilbao.',
    eu: 'San Juan de Gaztelugatxetik 10 min · Bilbotik 30 min.',
    fr: 'À 10 min de San Juan de Gaztelugatxe · 30 min de Bilbao.',
    en: '10 min from San Juan de Gaztelugatxe · 30 min from Bilbao.',
    it: 'A 10 min da San Juan de Gaztelugatxe · 30 min da Bilbao.',
    nl: 'Op 10 min van San Juan de Gaztelugatxe · 30 min van Bilbao.',
    no: '10 min fra San Juan de Gaztelugatxe · 30 min fra Bilbao.',
    da: '10 min fra San Juan de Gaztelugatxe · 30 min fra Bilbao.',
    de: '10 Min. von San Juan de Gaztelugatxe · 30 Min. von Bilbao.',
  },
  'footer.directTitle': {
  ...
  'story.title': {
    ...
    eu: 'Ez zara lotara etortzen.\nDeskonektatzera etortzen zara.',
    nl: 'Je komt niet om te slapen.\nJe komt om te ontspannen.',
    no: 'Du kommer ikke for å sove.\nDu kommer for å koble av.',
    da: 'Du kommer ikke for at sove.\nDu kommer for at koble af.',
  },
  'story.p0': {
    en: 'A boutique country house among vines and the silence of the Biscayan valley, ten minutes from San Juan de Gaztelugatxe and half an hour from Bilbao. Stone, wood and soft light.',
    fr: 'Une maison de campagne boutique parmi les vignes et le silence de la vallée biscayenne, à dix minutes de San Juan de Gaztelugatxe et une demi-heure de Bilbao. Pierre, bois et lumière douce.',
    de: 'Ein Boutique-Landhaus zwischen Reben und der Stille des biskayischen Tals, zehn Minuten von San Juan de Gaztelugatxe und eine halbe Stunde von Bilbao entfernt. Stein, Holz und sanftes Licht.',
    it: 'Una casa di campagna boutique tra le vigne e il silenzio della valle biscaglina, a dieci minuti da San Juan de Gaztelugatxe e mezz’ora da Bilbao. Pietra, legno e luce morbida.',
    eu: 'Landetxe boutique bat mahastien artean eta Bizkaiko haranaren isiltasunean, San Joan Gaztelugatxetik hamar minutura eta Bilbotik ordu erdira. Harria, egurra eta argi leuna.',
    nl: 'Een boutique-landhuis tussen de wijngaarden en de stilte van het Biskaje-dal, tien minuten van San Juan de Gaztelugatxe en een half uur van Bilbao. Steen, hout en zacht licht.',
    no: 'Et boutique-landsted blant vinranker og stillheten i Biscaya-dalen, ti minutter fra San Juan de Gaztelugatxe og en halvtime fra Bilbao. Stein, tre og mykt lys.',
    da: 'Et boutique-landsted blandt vinstokke og stilheden i Biscaya-dalen, ti minutter fra San Juan de Gaztelugatxe og en halv time fra Bilbao. Sten, træ og blødt lys.',
  },
  'story.p1': {
    ...
    eu: 'Hemen eguna Bakioren gaineko lainoarekin hasten da eta Kantauriaren soinuarekin amaitzen. Presarik gabe. Zaratarik gabe. Itsasoa, diseinua eta lasaitasuna, besterik ez.',
    nl: 'Hier begint de dag met mist boven Bakio en eindigt met het geluid van de Cantabrische Zee. Geen haast. Geen lawaai. Alleen zee, design en rust.',
    no: 'Her begynner dagen med tåke over Bakio og ender med lyden av Cantabriahavet. Uten hast. Uten støy. Bare hav, design og ro.',
    da: 'Her begynder dagen med tåge over Bakio og slutter med lyden af Det Cantabriske Hav. Uden hastværk. Uden støj. Kun hav, design og ro.',
  },
  ...
  'place.i0.d': {
    ...
    eu: 'Bizkaiko hondartza onenetako bat, surf egiteko eta paseatzeko.',
    nl: 'Een van de mooiste zandstranden van Biskaje om te surfen en te wandelen.',
    no: 'En av de beste sandstrendene i Biscaya for surfing og turer.',
    da: 'En af de bedste sandstrande i Biscaya til surfing og gåture.',
  },
  ...
  'place.i1.d': {
    en: 'The iconic islet and its hermitage, a 10-minute drive away.',
    fr: 'L’îlot emblématique et son ermitage, à 10 minutes en voiture.',
    de: 'Die ikonische Insel und ihre Einsiedelei, 10 Autominuten entfernt.',
    it: 'L’iconico isolotto e il suo eremo, a 10 minuti in auto.',
    eu: 'Uharte ikonikoa eta bere ermita, autoz 10 minutura.',
    nl: 'Het iconische eilandje en zijn kluis, op 10 autominuten.',
    no: 'Den ikoniske holmen og eremittboligen, ti minutter unna med bil.',
    da: 'Den ikoniske holm og dens kapel, ti minutters kørsel væk.',
  },
  ...
  'place.i2.d': {
    ...
    eu: 'Txakolina, berdea eta isiltasuna etxeko atarian.',
    nl: 'Txakoli, groen en stilte voor de deur.',
    no: 'Txakoli, grønt og stillhet rett utenfor døren.',
    da: 'Txakoli, grønt og stilhed lige uden for døren.',
  },
  ...
  'concierge.greeting': {
    ...
    eu: 'Kaixo! GURAHeko conciergea naiz. Bakiora lehen aldiz zatoz? Hondartzak, surfa, Gaztelugatxe, txakolindegiak edo jatetxeak gomenda diezazkizuket — eta, nahi baduzu, zure bidaiarako apartamentu ezin hobea.',
    nl: 'Hallo! Ik ben de concierge van GURAH. Voor het eerst in Bakio? Ik kan stranden, surf, Gaztelugatxe, txakoli-wijnhuizen of restaurants aanraden — en, als je wilt, het perfecte appartement voor je reis.',
    no: 'Hei! Jeg er conciergen på GURAH. Første gang i Bakio? Jeg kan anbefale strender, surf, Gaztelugatxe, txakoli-vingårder eller restauranter — og, om du vil, den perfekte leiligheten for reisen din.',
    da: 'Hej! Jeg er concierge på GURAH. Første gang i Bakio? Jeg kan anbefale strande, surf, Gaztelugatxe, txakoli-vingårde eller restauranter — og, hvis du vil, den perfekte lejlighed til din rejse.',
  },
...
const APART_I18N: Record<string, ApartCopy> = {
  lurra: {
    concepto: {
      ...
      eu: 'Landetxearen beheko solairua · 3 logela',
      nl: 'Begane grond van het landhuis · 3 slaapkamers',
      no: 'Første etasje i landstedet · 3 soverom',
      da: 'Stueetage i landstedet · 3 soveværelser',
    },
    storytelling: {
      ...
      eu: 'Etxearen beheko solairua, sarrera pribatuarekin eta dena maila berean. Harri eta egurrezko hiru logela sei lagunentzat, lorategira eta mendira begira, eta igerilekua, gimnasioa eta solariuma pauso batera. Etxetik atera gabe deskonektatzeko abiapuntu ezin hobea.',
      nl: 'De begane grond van het huis, met een privé-ingang en alles gelijkvloers. Drie slaapkamers van steen en hout voor maximaal zes personen, met uitzicht op de tuin en de bergen, en het zwembad, de fitnessruimte en het solarium op een steenworp afstand. Het perfecte vertrekpunt om te ontspannen zonder het huis te verlaten.',
      no: 'Husets første etasje, med privat inngang og alt på ett plan. Tre soverom i stein og tre for opptil seks personer, med utsikt til hagen og fjellet, og bassenget, treningsrommet og solterrassen bare noen skritt unna. Det perfekte utgangspunktet for å koble av uten å forlate huset.',
      da: 'Husets stueetage, med privat indgang og alt i ét plan. Tre soveværelser i sten og træ til op til seks personer, med udsigt til haven og bjergene, og poolen, fitnessrummet og solterrassen kun få skridt væk. Det perfekte udgangspunkt for at koble af uden at forlade huset.',
    },
  },
  zerua: {
    concepto: {
      ...
      eu: 'Landetxearen goiko solairua · 2 logela',
      nl: 'Bovenverdieping van het landhuis · 2 slaapkamers',
      no: 'Øverste etasje i landstedet · 2 soverom',
      da: 'Øverste etage i landstedet · 2 soveværelser',
    },
    storytelling: {
      ...
      eu: 'Goian, argiak agintzen duen lekuan. Bi logela bikoitz euskal teilatupean, nortasuneko sabaiak eta haranera eta mendira begirako bista zabalak. Sarrera pribatua eta eskaileraz sartzeko; igerilekua, gimnasioa eta solariuma etxearekin partekatzen ditu, eta isiltasuna eta zerua beretzat gordetzen.',
      nl: 'Boven, waar het licht heerst. Twee tweepersoonsslaapkamers onder het Baskische dak, karaktervolle plafonds en een weids uitzicht op de vallei en de bergen. Privé-ingang en toegang via de trap; deelt zwembad, fitnessruimte en solarium met het huis, en houdt de stilte en de hemel voor zich.',
      no: 'Oppe, der lyset rår. To dobbeltsoverom under det baskiske taket, tak med karakter og åpen utsikt til dalen og fjellet. Privat inngang og adkomst via trapp; deler basseng, treningsrom og solterrasse med huset, og beholder stillheten og himmelen for seg selv.',
      da: 'Foroven, hvor lyset hersker. To dobbeltværelser under det baskiske tag, lofter med karakter og åben udsigt til dalen og bjergene. Privat indgang og adgang via trappe; deler pool, fitnessrum og solterrasse med huset og beholder stilheden og himlen for sig selv.',
    },
  },
  bakea: {
    concepto: {
      ...
      eu: 'Apartamentua terrazarekin, hondartzaren ondoan',
      nl: 'Appartement met terras, vlak bij het strand',
      no: 'Leilighet med terrasse, ved stranden',
      da: 'Lejlighed med terrasse, ved stranden',
    },
    storytelling: {
      ...
      eu: 'Bakioko hondartzatik gertu, oinez. Berrogeita hamazazpi metro diseinu epelekoak, terraza eta lorategiarekin, igerilekua eta tenis-padel pistak eguzki-egunetarako. Itsasotik presarik gabe itzultzeko aterpe argitsua. Maskota-lagunkoia.',
      nl: 'Op een wandeling van het strand van Bakio. Zevenenvijftig vierkante meter warm design met terras en tuin, zwembad en tennis-padelbanen voor zonnige dagen. Het lichte toevluchtsoord om zonder haast terug te komen van zee. Huisdiervriendelijk.',
      no: 'En kort spasertur fra stranden i Bakio. Femtisju kvadratmeter med varm design, terrasse og hage, basseng og tennis-padelbaner for solfylte dager. Det lyse tilfluktsstedet for å komme tilbake fra havet uten hast. Kjæledyrvennlig.',
      da: 'En kort gåtur fra stranden i Bakio. Syvoghalvtreds kvadratmeter varmt design med terrasse og have, pool og tennis-padelbaner til solskinsdage. Det lyse tilflugtssted til at vende hjem fra havet uden hastværk. Kæledyrsvenlig.',
    },
  },
};
